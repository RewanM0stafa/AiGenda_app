...
// ════════════════════════════════════════════════════════════
// Shared private widgets — مستخدمة في الـ screens فوق
// ════════════════════════════════════════════════════════════
...
Widget backButton() => Container(
  ...
  decoration: BoxDecoration(
    ...
    borderRadius: BorderRadius.circular(12),
    border:
    Border.all(color: const Color(0xFFE8E4F5), width: 1.2),
    boxShadow: [
      BoxShadow(
...
InputDecoration fieldDecoration({
  ...
  return InputDecoration(
    ...
    filled: true,
    fillColor:
    isLoading ? const Color(0xFFEFEEF5) : const Color(0xFFF7F5FF),
    contentPadding:
    const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
    border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
    ...
    errorStyle:
    GoogleFonts.poppins(fontSize: 11, color: const Color(0xFFE74C3C)),
  );
}
